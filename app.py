...
st.caption(
    ...
    "implemented in pure NumPy across five datasets. Stanford CS109 coursework."
)
...
# ═══════════════════════════════════════════════════════════════════════════════
# TAB 1 — simple logistic regression
# ═══════════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════════
# TAB 2 — ancestry classifier (23andMe-style SNP data)
# ═══════════════════════════════════════════════════════════════════════════════
...
with tab2:
    ...
    w2, _ = train_logreg(X_tr2, y_tr2, lr=lr2, steps=steps2)
...
# ═══════════════════════════════════════════════════════════════════════════════
# TAB 3 — heart disease: learning rate search
# ═══════════════════════════════════════════════════════════════════════════════
...
with tab3:
    ...
    rows3 = []
    for eta in lrs3:
        w3, _ = train_logreg(X_tr3, y_tr3, lr=eta, steps=1000)
        rows3.append({"η": eta, "Test accuracy": acc(predict_proba(X_te3, w3), y_te3)})
    ...
    with c_plot3:
        ...
        _, lls_best3  = train_logreg(X_tr3, y_tr3, lr=best3["η"], steps=1000)
        worst3_eta = lrs3[df3["Test accuracy"].values.argmin()]
        _, lls_worst3 = train_logreg(X_tr3, y_tr3, lr=worst3_eta, steps=1000)
